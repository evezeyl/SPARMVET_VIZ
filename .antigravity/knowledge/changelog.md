...
- Fragment conventions + threshold (inline ≤80 lines / ≤2 schemas / ≤3 plots) documented in `.antigravity/knowledge/manifest_data_contract_rules.md` §6.
...
### Execution plan
See task `ASSEMBLY-RENAME` in `.antigravity/tasks/tasks.md` for the 5-pass VSCode checklist.
