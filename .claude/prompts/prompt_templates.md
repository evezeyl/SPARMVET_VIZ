...
- Locate the current active task in ./.claude/tasks/tasks.md.
...
Before beginning a task, STATE which rulebook you are consulting. If a task involves creating a new plot component, you MUST read ./.claude/workflows/viz_factory_implementation.md first.
...
"@dasharch: RE-SYNC. The previous integrity suites have finished. Check ./.claude/logs/audit_2026-04-09.md for the result and continue."
...
- architecture decisions: ./.claude/knowledge/architecture_decisions.md and
- implementation plan: ./.claude/plans/implementation_plan_master.md
...
in ./.claude/logs/audit_{{YYYY-MM-DD}}.md
...
Update Completed tasks in ./.claude/tasks/tasks.md.
```
