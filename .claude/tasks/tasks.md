...
- [ ] **DIAG-CLI-1** `[haiku/low]`: Audit remaining CLI scripts (`assets/scripts/*.py`, `scripts/install_libs.sh` Python helpers) for failure modes that should emit `DeploymentError`-formatted output for consistency. ADR-078 Phase C tail.
