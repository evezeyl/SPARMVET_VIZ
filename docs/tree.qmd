...
│   └── bio_viz_core/                       # The "Visual" Unit : Plotting logic (Independent) : takes tidy data and manifest (labels, colors) and returns Figure objects 
