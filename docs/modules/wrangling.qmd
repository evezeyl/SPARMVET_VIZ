...
### 2. Metadata Manager (Orchestrator: Metadata Join & exploratory Filters and Select) `metadata_mgr.py` 
#REVIEW - It is still unclear if it should be on this layer but it seems to me
> metadata and queries

**Input:** `data_tier1 + User-uploaded Metadata.

**Action:** 
- validates the metadata. Plotnine requieres tidydata, if the data isn't tidy, it wont be possible to draw. 
