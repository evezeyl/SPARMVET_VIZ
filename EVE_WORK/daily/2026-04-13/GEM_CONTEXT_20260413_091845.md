...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/Bracken_output_fields.yaml
````yaml
sample_id:
  type: numeric
taxon_1:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/FastP_output_fields.yaml
````yaml
sample_id:
  type: numeric
total_reads:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/metadata_schema_output_fields.yaml
````yaml
sample_id:
  type: numeric
source:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/MLST_output_fields.yaml
````yaml
sample_id:
  type: numeric
scheme:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/Quality_metrics_output_fields.yaml
````yaml
output_fields:
  sample_id:
    label: "Sample ID"
  ...
  total_reads_after:
    label: "Total Reads After"
  ratio_reads_after:
    label: "Ratio Reads After"
  bracken_main_taxon:
    label: "Bracken Main Taxon"
  proportion_of_main_taxon:
    label: "Proportion Of Main Taxon"
  n50:
    label: "N50"
  total_length:
    label: "Total Length"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/Quast_output_fields.yaml
````yaml
sample_id:
  type: numeric
n50:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/ResFinder_output_fields.yaml
````yaml
sample_id:
  type: numeric
gene:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/ST22_Anchor_final_output_fields.yaml
````yaml
output_fields:
  sample_id:
    type: numeric
  ...
  sequence_type:
    type: categorical
    label: "MLST Sequence Type"
  serotype:
    type: categorical
    label: "Serotype"
  Selected_Virulence_Genes:
    type: categorical
    label: "Gene (VirulenceFinder)"
  VF_protein:
    type: categorical
    label: "Protein (VirulenceFinder)"
  gene:
    type: categorical
    label: "AMR Gene"
  status:
    type: categorical
    label: "Phenotype Status"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/Summary_output_fields.yaml
````yaml
sample_id:
  type: numeric
taxon:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/VirulenceFinder_output_fields.yaml
````yaml
sample_id:
  type: numeric
serotype:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/plots/FastP_reads_boxplot.yaml
````yaml
...
## File: assets/template_manifests/1_test_data_ST22_dummy/plots/FastP_reads_horizontal_barplot.yaml
````yaml
...
## File: assets/template_manifests/1_test_data_ST22_dummy/plots/integration_plot.yaml
````yaml
factory_id: "heatmap_logic"
target_dataset: "ST22_Anchor"
x: "Selected_Virulence_Genes"
y: "sample_id"
facet_by: "sequence_type"
color: "status"
title: "Integrated Virulence & MLST Typing"
family: "Correlation"
pattern: "2 Categorical"
description: "Heatmap showing the distribution of whitelisted virulence genes, facetted by the MLST sequence type."
difficulty: "Advanced"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/plots/MLST_counts_bar.yaml
````yaml
factory_id: "bar_logic"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/plots/Quast_assembly_quality_barplot.yaml
````yaml
factory_id: "boxplot_logic"
target_dataset: "Quast_with_metadata"
x: "metric"
y: "value"
facet_by: "metric"
facet_scales: "free_y"
fill: "metric"
title: "Assembly Quality Metrics (Quast)"
family: "Distribution"
pattern: "1 Numeric, 1 Categorical"
description: "Facetted boxplot to identify assembly outliers across metrics (N50, Length, etc.)."
difficulty: "Intermediate"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/plots/ResFinder_genes_heatmap.yaml
````yaml
factory_id: "heatmap_logic"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/plots/VirulenceFinder_counts_bar.yaml
````yaml
factory_id: "bar_logic"
target_dataset: "ST22_Anchor"
x: "sample_id"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/PlasmidFinder_wrangling.yaml
````yaml
sample_id:
...
identity:
  ...
  label: '%Identity'
overlap:
  original_name: '%Overlap'
  type: numeric
  label: '%Overlap'
hsp_lengthtotal_length:
  original_name: HSP Length/Total Length
  type: categorical
  label: Hsp Length/Total Length
contig:
...
start:
  ...
  label: End
accession:
  original_name: Accession
  type: categorical
  label: Accession
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Quality_metrics_assembly_wrangling.yaml
````yaml

````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Quality_metrics_wrangling.yaml
````yaml
wrangling: []
````

## File: config/manifests/pipelines/STRESS_FINAL.yaml
````yaml
id: "STRESS_FINAL"
info:
  display_name: "STRESS: Master Verification"
  description: "Bulletproof stress test manifest for Phase 12-A verification."

data_schemas:
  Stress_Source:
    source:
      type: "local_tsv"
      path: "assets/test_data/STRESS/STRESS_data.tsv"
    input_fields:
      id: { type: "string", is_primary_key: true }
      species: { type: "string" }
...
assembly_manifests:
  Master_Collection:
    ingredients:
      - dataset_id: "Stress_Source"
    recipe:
      tier1: []

plots:
  final_plot:
    title: "Master Proof: 10,000 Rows Distribution"
    mapping:
      x: "species"
      fill: "amr_class"
    layers:
      ...
      - name: "labs"
        params:
          title: "STRESS TEST: Species x AMR Distribution"
          x: "Species"
          y: "Observed Count"
````

## File: config/manifests/pipelines/The_Truth.yaml
````yaml
id: "The_Truth"
info:
  display_name: "STRESS: The Absolute Truth"
  description: "Verified manifest for Comparison Theater Stress Test."
...
plots:
  master_plot:
    title: "10,000 Row Species Distribution"
    mapping:
      x: "species"
      fill: "amr_class"
    layers:
      ...
      - name: "labs"
        params:
          title: "Phase 12-A Verification: 10,000 Rows"
          x: "Species"
          y: "Count"
````
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/Bracken_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
    ...
    is_primary_key: true
  taxon_1:
    original_name: "taxon_1"
    type: categorical
    label: "Primary Taxon"
  proportion_1:
    original_name: "proportion_1"
    type: numeric
    label: "Primary Proportion"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/Detailed_summary_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: sample_id
  ...
  data_type:
    ...
    label: Data Type
  predicted_phenotype:
    original_name: Predicted Phenotype
    type: categorical
    label: Predicted Phenotype
  cge_predicted_phenotype:
    original_name: CGE Predicted Phenotype
    type: categorical
    label: Cge Predicted Phenotype
  identity:
    original_name: '%Identity'
    type: numeric
    label: '%Identity'
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/FastP_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
    ...
    is_primary_key: true
  total_reads:
    original_name: "total_reads"
    type: numeric
    label: "Total Reads"
  q30_rate:
    original_name: "q30_rate"
    type: numeric
    label: "Q30 Rate"
  gc_content:
    original_name: "gc_content"
    type: numeric
    label: "GC Content"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/metadata_schema_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/MLST_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/Quality_metrics_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: sample_id
    ...
    is_primary_key: true
  quality_module:
    original_name: Quality_Module
    type: categorical
    label: Quality Module
  quality_feedback:
    original_name: Quality_Feedback
    type: categorical
    label: Quality Feedback
  total_reads_after:
    original_name: total_reads_after
    type: numeric
    label: Total Reads After
  ratio_reads_after:
    original_name: ratio_reads_after
    type: numeric
    label: Ratio Reads After
  bracken_main_taxon:
    original_name: bracken_main_taxon
    type: categorical
    label: Bracken Main Taxon
  proportion_of_main_taxon:
    original_name: proportion_of_main_taxon
    type: numeric
    label: Proportion Of Main Taxon
  reads_gc_content:
    original_name: reads_gc_content
    type: numeric
    label: Reads Gc Content
  n50:
    original_name: N50
    type: numeric
    label: N50
  total_length:
    original_name: Total_length
    type: numeric
    label: Total Length
  largest_contig:
    original_name: Largest_contig
    type: numeric
    label: Largest Contig
  num_contigs_500bp:
    original_name: num_contigs_500bp
    type: numeric
    label: Num Contigs 500Bp
  num_contigs_0bp:
    original_name: num_contigs_0bp
    type: numeric
    label: Num Contigs 0Bp
````

## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/ResFinder_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/Summary_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
  ...
  genotype:
    original_name: "Genotype"
    type: categorical
    # label omitted as same as original_name/key
  genome_length:
    original_name: "Genome Length"
    type: numeric
    label: "Genome Length"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/VirulenceFinder_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
  ...
  serotype:
    ...
    type: categorical
    label: "Serotype (Finder)"
  virulence_raw:
    original_name: "virulence_finder_virulencegenes_proteinname"
    type: categorical
    label: "Raw Virulence Hit"
````

## File: assets/template_manifests/1_test_data_ST22_dummy/output_fields/Detailed_summary_output_fields.yaml
````yaml
output_fields:
  sample_id:
    label: "Sample ID"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Bracken_Metadata_wrangling.yaml
````yaml
tier1:
  - action: "join"
    right_ingredient: "metadata_schema"
    "on": ["sample_id"]
# tier2: not needed — joined wide format ready for tabular display
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Bracken_wrangling.yaml
````yaml
tier1: []
# tier2: not applicable
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Detailed_Summary_assembly_wrangling.yaml
````yaml
- action: "left_join"
  right_ingredient: "metadata_schema"
  on: ["sample_id"]
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Detailed_summary_wrangling.yaml
````yaml
tier1:
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/FastP_Metadata_wrangling.yaml
````yaml
tier1:
  - action: "join"
    right_ingredient: "metadata_schema"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/FastP_wrangling.yaml
````yaml
tier1: []
# tier2: not applicable
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/metadata_schema_wrangling.yaml
````yaml
tier1: []
# tier2: not applicable
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/MLST_Metadata_wrangling.yaml
````yaml
tier1:
  - action: "join"
    right_ingredient: "metadata_schema"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/QC_Reads_Anchor_wrangling.yaml
````yaml
tier1:
  # RELATIONAL ANCHOR: QC Reads
  # Combines reads metrics (FastP), assembly metrics (Quast), and taxonomy (Bracken) with metadata.
  - action: "join"
    right_ingredient: "Quast"
    "on": ["sample_id"]
  - action: "join"
    right_ingredient: "Bracken"
    "on": ["sample_id"]
  - action: "join"
    right_ingredient: "metadata_schema"
    "on": ["sample_id"]
# tier2: not needed — wide QC table ready for tabular/faceted display
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Quast_Metadata_wrangling.yaml
````yaml
tier1:
  - action: "join"
    right_ingredient: "metadata_schema"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/ResFinder_Metadata_wrangling.yaml
````yaml
tier1:
  - action: "join"
    right_ingredient: "metadata_schema"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/ST22_Anchor_wrangling.yaml
````yaml
tier1:
...
# tier2: (future) aggregation / long-format reshaping for specific plot types
# tier2: []
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Summary_wrangling.yaml
````yaml
tier1: []
# tier2: not applicable
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/VirulenceFinder_wrangling.yaml
````yaml
tier1:
  - action: "keep_columns"
  ...
  - action: "strip_whitespace"
  - action: "unique_rows"
# tier2: not needed — wide per-gene format ready for dot/heatmap plots
````

## File: config/manifests/pipelines/STRESS_project.yaml
````yaml
id: "STRESS_project"
info:
  display_name: "UI Stress Test Project"
  description: "A 10,000 row dataset for verifying Tier 3 responsiveness and Comparison Theater."
...
assembly_manifests:
  STRESS_Collection:
    ingredients:
      - dataset_id: "Stress_Data_Source"
    recipe:
      tier1: []

plots:
  stress_plot:
    title: "10,000 Row Stress Distribution"
    mapping:
      x: "species"
      fill: "amr_class"
    layers:
      ...
      - name: "labs"
        params:
          title: "Stress Test: Species Distribution (10k Rows)"
          x: "Species"
          y: "Count"
````
...
## File: assets/template_manifests/1_test_data_ST22_dummy/input_fields/Quast_input_fields.yaml
````yaml
input_fields:
  sample_id:
    original_name: "sample_id"
...
## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/MLST_wrangling.yaml
````yaml
tier1:
  - action: "keep_columns"
    columns: ["sample_id", "scheme", "sequence_type"]
# tier2: not needed — data ready for tabular display as-is
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/ResFinder_wrangling.yaml
````yaml
tier1:
  - action: "add_constant"
    new_column: "status"
    value: "Detected"
# tier2: not needed — data ready for tabular/heatmap display as-is
````

## File: assets/template_manifests/1_test_data_ST22_dummy/wrangling/Quast_wrangling.yaml
````yaml
tier1:
  - action: "strip_whitespace"
# tier2: not needed — data ready for tabular display as-is
...
## File: assets/template_manifests/1_test_data_ST22_dummy.yaml
````yaml
