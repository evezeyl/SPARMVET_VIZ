...
- **`./.claude/logs/`**: **Log Authority**. ALL session audits and daily logs MUST be stored in `./.claude/logs/audit_{YYYY-MM-DD}.md`. The creation of log files in the project root or `EVE_WORK/` is strictly FORBIDDEN.
