...
## File: /home/evezeyl/Documents/Insync/gdrive/OBSWORK/20_GITS/SPARMVET_VIZ/.claude/rules/dasharch.md
````markdown
---
trigger: manual
...
1. READ-ONLY CONTEXT:
   * Rules/Persona: `./.claude/rules/`
   * Custom Skills: `./.claude/skills/`
   * Logic Flows: `./.claude/workflows/`

2. OPERATIONAL STATE (MANAGED):
   * Active Tasks: `./.claude/tasks/`
   * Local Memory: `./.claude/knowledge/` - `./.claude/embeddings/`
   * Session History: `./.claude/conversations/`
